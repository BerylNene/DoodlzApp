   ...
   public boolean onOptionsItemSelected(MenuItem item) 
   {
      ...
      switch (item.getItemId()) 
      {
         ...
         case R.id.lineWidth:
            ...
            return true; // consume the menu event
         case R.id.eraser:
            doodleView.setDrawingColor(DoodleView.getBackgroundColor()); // line color to background color
            return true; // consume the menu event
         case R.id.clear:
         ...
         case R.id.import_image:     
             ...
             return true; // Allows the user to select pictures from phone gallery
         case R.id.print:     
