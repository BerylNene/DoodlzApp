...
public class DoodleView extends View 
{
   ...
   private static int backgroundColor;  //used to set the background color
   ...
   public DoodleView(Context context, AttributeSet attrs)  
   {
     ...
     // paintLine.setBackgroundColor(Color.RED); // default color is black
